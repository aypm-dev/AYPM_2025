<script lang="ts">
    ...
    interface project {
        title: string,
        description: string,
        modal?: typeof SvelteComponent | typeof Innoceana,
        grid_area: string,
        image_src?: string,
        show_kiwi?: boolean,
    }
...
<div class="relative w-screen h-fit mt-24 mb-48 p-12 shadow-lg text-snow border-t-[3px] border-b-[6px] border-eerie-900 bg-folly ">
    <div class="container flex mx-auto justify-center">
        <div class="w-full flex flex-col md:w-2/3 items-center">
            ...
            <div in:fly={{y:20, duration:500+(Math.random() * 300), delay:(Math.random() * 500)}} class="absolute flex justify-center items-center sm:-top-20 -top-10 -translate-y-1/2 left-[80%] md:left-[76%] z-10 w-12 aspect-square rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-folly">
            ...
            <div in:fly={{y:20, duration:500+(Math.random() * 300), delay:(Math.random() * 600)}} class="absolute flex top-[3rem] -translate-y-1/2 left-[-4%] md:left-[18%] z-10 w-20 aspect-square p-2 justify-center items-center rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-folly">
