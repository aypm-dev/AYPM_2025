...
<section class="relative container mt-24">
	<h2
	...
	<div
		...
		class="relative flex w-5/6 sm:w-1/2 h-32 mx-auto rounded-xl shadow-lg select-none bg-red-500"
	>
		<ul
			class="grid grid-cols-5 gap-4 w-full p-4 bg-white rounded-xl border-[3px] border-b-[6px] border-eerie-900"
		>
			<li class="flex w-[60%] aspect-square mx-auto my-auto justify-center items-center shrink-0">
				<img
			...
			<li class="flex w-2/3 aspect-square mx-auto my-auto justify-center items-center">
				<img
			...
			<li class="flex w-2/3 aspect-square mx-auto my-auto justify-center items-center">
				<img
					style="filter: drop-shadow(0 0.35rem 0.2px black) saturate(80%)"
					src="technologies/angular-logo.png"
					loading="lazy"
					alt="ANGULAR Logo"
					draggable="false"
					class="h-full pointer-events-none"
		...
		<ui
			...
			class="absolute grid grid-cols-5 h-full gap-4 w-full p-4 overflow-hidden bg-folly rounded-xl border-[3px] border-b-[6px] border-eerie-900"
		>
			<li class="flex w-2/3 aspect-square mx-auto my-auto justify-center items-center shrink-0">
				<img
					style="filter: drop-shadow(0 0.35rem 0.2px black) saturate(110%)"
			...
			<li class="flex w-2/3 aspect-square mx-auto my-auto justify-center items-center shrink-0">
				<img
					style="filter: drop-shadow(0 0.35rem 0.2px black) saturate(110%)"
					src="technologies/sveltekit-logo.png"
					loading="lazy"
					alt="SVELTEKIT Logo"
					draggable="false"
					class="pointer-events-none"
			...
			<li class="flex w-2/3 aspect-square mx-auto my-auto justify-center items-center shrink-0">
				<img
					style="filter: drop-shadow(0 0.35rem 0.2px black) saturate(110%)"
					src="technologies/analog-logo.svg"
					loading="lazy"
					alt="ANALOG Logo"
					draggable="false"
					class="pointer-events-none"
		...
		<span class="absolute text-sm -bottom-2 translate-y-full select-none">
