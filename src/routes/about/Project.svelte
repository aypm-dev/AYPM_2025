...
<div style="grid-area: {grid_area};" class="relative flex flex-col h-full px-2 pt-4 pb-12 items-center rounded-xl border-[3px] border-b-[6px] border-eerie-900 ring-2 ring-white shadow-lg bg-folly">
    <span class="text-2xl font-bold"> {title.toUpperCase()} </span>
