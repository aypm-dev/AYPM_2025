...
<section class="relative mb-[32rem] sm:mb-64 overflow-x-clip">
    <div class="relative w-80 sm:w-2/3 h-[40rem] sm:h-96 mt-12 px-6 py-8 sm:p-12 rounded-r-xl shadow-lg text-snow border-l-0 border-[3px] border-b-[6px] border-eerie-900 bg-folly">
        <div class="sm:w-1/2 sm:ml-auto">
            <h1 class="text-6xl sm:text-7xl text-center"> CONTACT ME? </h1>
