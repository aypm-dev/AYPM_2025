...
<section class="flex flex-col w-fit h-[42rem] mt-12 relative mx-auto">
	{#if show_factory}
		<div class="grid grid-cols-3 w-full sm:w-[40rem] gap-2">
			<h1
			...
			<section
				in:enter={{ delay: 400, duration: 2000 }}
		...
		<div
			in:fade={{ delay: 3000, duration: 500 }}
		...
		<div class="relative mt-4">
			<div
				in:fade={{ delay: 2250, duration: 500 }}
