...
<section class="flex flex-col w-fit h-[42rem] mt-12 relative mx-auto">
	<ul class="grid grid-cols-3 w-full sm:w-[40rem] gap-2">
		<h1
			in:fade|global={{ delay: 1750, duration: 500 }}
		...
		>
			<svg
				in:enter|global={{ delay: 10, duration: 1900 }}
				class="animate-random-jumps -mt-8 sm:-mt-11 sm:w-8 sm:h-8 w-6 h-6"
				viewBox="0 0 512 512"
				><path
			...
			<div class="flex w-full p-1 mt-auto gap-2 sm:p-4 sm:gap-6">
				<div
					class="w-1/3 h-16 rounded-t-[48px] rounded-b-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
				/>
				<div
					class="w-1/3 h-16 rounded-t-[48px] rounded-b-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
				/>
		...
		<li
			in:enter|global={{ delay: 200, duration: 2000 }}
		...
		<li
			in:enter|global={{ delay: 400, duration: 2000 }}
			class="relative flex flex-col h-80 sm:h-96 text-right text-xs pt-4 p-1 sm:pt-2 sm:p2 rounded-xl rounded-tr-[48px] sm:rounded-t-[48px] border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
		>
	...
	<div
		in:fade|global={{ delay: 2000, duration: 500 }}
		class="absolute flex left-[calc(66.666667%-0.25rem)] -translate-x-full w-16 h-[5rem] p-2 justify-center rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
	>
		<div
			class="flex w-9 rounded-t-[48px] rounded-b-xl border-[3px] border-b-[6px] items-end border-eerie-900 shadow-lg overflow-clip"
		>
			<svg
				in:enter|global={{ delay: 10, duration: 1900 }}
				class="-translate-x-3 sm:w-8 sm:h-8 w-6 h-6"
				viewBox="0 0 512 512"
				><path
					d="m507.606 228.536-50.509-50.509a124.386 124.386 0 0 1-16.631 20.622l-2.586 2.586 48.514 48.513c5.857 5.857 15.355 5.857 21.213 0 5.857-5.857 5.857-15.355-.001-21.212zM256 465.946h-58.054l-53.571-53.571a182.442 182.442 0 0 1-31.908-4.071v8.375c0 3.979 1.581 7.794 4.394 10.606l39.119 39.119c-6.531 1.622-11.379 7.508-11.379 14.542 0 8.284 6.716 15 15 15H256c8.284 0 15-6.716 15-15s-6.716-15-15-15zM419.391 43.92c-.109-.112-.22-.223-.332-.331-37.002-36.834-96.691-36.649-133.491.172l-35.782 35.781 16.117 16.117c5.858 5.857 5.858 15.355 0 21.213-5.857 5.857-15.355 5.857-21.213 0l-37.33-37.33h-55.97C67.914 79.542 0 147.455 0 230.964 0 316.283 69.377 382.53 151.642 382.53c39.341 0 77.915-15.397 106.964-44.446L419.25 177.44c36.797-36.809 36.845-96.662.141-133.52zm-35.924 67.492c0 8.284-6.716 15-15 15s-15-6.716-15-15V95.345c0-8.284 6.716-15 15-15s15 6.716 15 15z"
				/></svg
	...
	<div
		in:fade|global={{ delay: 3000, duration: 500 }}
		class="absolute flex top-[28rem] sm:top-[36rem] left-[80%] sm:left-[90%] h-8"
	>
	...
	<div
		in:fade|global={{ delay: 2000, duration: 500 }}
		class="absolute flex top-80 sm:top-96 left-[calc(66.66667%+0.25rem)] mt-4 gap-2"
	>
		<div
			class="w-8 h-20 p-2 rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
		/>
		<div
			class="w-8 sm:w-24 h-16 p-2 gap-4 mt-2 rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white"
		/>
		<div
			class="w-8 h-[24rem] mt-2 p-2 rounded-xl shadow-lg rounded-tr-[128px] border-[3px] border-b-[6px] border-eerie-900 ring-4 ring-white bg-folly"
		/>
	</div>

	<div class="relative mt-4">
		<div
			in:fade|global={{ delay: 2250, duration: 500 }}
			class="absolute p-2 left-[66.666667%] -translate-x-1/2 -translate-y-1/2 gap-4 w-fit h-fit items-center rounded-xl border-[3px] border-b-[6px] border-eerie-900 shadow-lg bg-white ring-4 ring-white sm:ring-transparent"
		>
