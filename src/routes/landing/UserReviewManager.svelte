<script lang="ts">
	...
	$: parsed_user_review = user_review
		.replace(/[^\w\s\']|_/g, '')
		.replace(/\s+/g, ' ')
		.toLowerCase();
</script>
...
<section
	class="container gradients-mask hidden sm:grid grid-cols-3 xl:grid-cols-7 h-[27rem] mt-24 gap-8 object-center overflow-hidden"
>
	<ul
	...
	<div class="xl:col-span-3 flex flex-col h-[50%] justify-center">
		...
		{#key parsed_user_review === 'man i love this website'}
			<p in:fly={{ y: -5, duration: 100 }} class="mt-4 text-xl text-center">
				{#if parsed_user_review === 'man i love this website'}
...
<div class="flex horizontal-gradients-mask sm:hidden relative h-32 mt-4 overflow-clip">
	<ul
